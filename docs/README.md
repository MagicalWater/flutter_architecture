...
- `docs/guides/`：可重複使用的操作指南；CI／Branch Protection操作請讀`docs/guides/ci_cd_operations.md`，native environment與產品識別採用請讀`docs/guides/native_environment_adoption.md`。
