...
> [!WARNING]
> **Historical / partially superseded first-phase guidance.** 基本依賴方向仍具參考價值，但內文的第一階段scope、storage authority與future feature敘述不代表current state。Current snapshot請讀取`docs/project_context.md`；canonical Decisions請讀取`docs/adr/README.md`。
