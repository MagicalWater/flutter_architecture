...
- [`milestone_34/34-3_asset_typography_pressure_evidence.md`](milestone_34/34-3_asset_typography_pressure_evidence.md)：Task 34-3目前等待external fresh-chat behavioral evidence；Codex `401 Unauthorized`只代表optional automated harness不可用，PTF-13～PTF-18已完成static contract。
