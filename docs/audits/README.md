...
- [`milestone_35/35-d_corrective_design_review.md`](milestone_35/35-d_corrective_design_review.md)：proposed Corrective Design的focused findings、fresh re-review、whole-Design coverage、authority check與Design approval gate evidence。
