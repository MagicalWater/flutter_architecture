...
- [`milestone_40/40-7p_hero_visual_plan_review.md`](milestone_40/40-7p_hero_visual_plan_review.md)：visual-family extraction、single-candidate generation、native-image identity、deterministic preview、user visual gate與regeneration budget的Plan review；目前等待使用者Plan核准。
