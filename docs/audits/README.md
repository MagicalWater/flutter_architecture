...
- [`milestone_40/40-7t_title_artwork_review.md`](milestone_40/40-7t_title_artwork_review.md)：`Flutter Enterprise Architecture Template` title-artwork candidate的actual inline preview、360／700 downscale、light／dark framing、focused與whole-candidate review；README promotion仍等待使用者visual acceptance。
