...
- [`milestone_32/32-9_runtime_acceptance_review.md`](milestone_32/32-9_runtime_acceptance_review.md)：Task 9 Windows quality／Android、failure evidence、GitHub no-growth與self-hosted offline acceptance；Mac manual-local與self-hosted success目前受connector／runner阻塞。
