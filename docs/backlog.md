...
- Cryptographic Device Binding與Passkey；目前1.4.0提供credential-at-rest hardening與Server-issued OTP，Milestone 21也只規劃local user-presence gate，均未承諾rooted device、runtime memory或server compromise防護。
