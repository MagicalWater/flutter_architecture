...
class _CatalogPageResponseDto implements CatalogPageResponseDto {
  const _CatalogPageResponseDto({@JsonKey(fromJson: _itemsFromJson, toJson: _itemsToJson) required final  List<CatalogItemDto> items, this.nextCursor}): _items = items;
