...
class IosWorkflowContractTest(unittest.TestCase):
    ...
    def test_uses_stable_named_macos_simulator_build_gate(self) -> None:
        ...
        self.assertIn("bash tools/ci/build_ios_simulator.sh", self.text)
    ...
    def test_failure_diagnostics_are_bounded_and_not_a_distribution_artifact(self) -> None:
        ...
        self.assertNotIn("flutter-architecture-ios", self.text)
